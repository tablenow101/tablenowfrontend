...
// Authentication yields a Supabase session in every case. Email/password uses
// supabase.auth.signInWithPassword; Google uses signInWithOAuth. After a password
// login we call ensureRestaurant (links/creates the restaurant for this session),
// then follow the backend's next_route — never a locally-guessed route.
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      // Ensure the restaurant exists / is linked to this Supabase user, then route
      // via the backend contract.
